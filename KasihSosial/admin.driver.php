...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign'])) {
    ...
    dbQuery("UPDATE tugas_pengantaran SET driver_id = ?, status_pengantaran = 'Pending'
             WHERE tugas_id = ? AND driver_id IS NULL",
            'ii', [$driver_id, $tugas_id]);
              ...
              <div class="row g-2 mb-3">
                <div class="col-6">
                  <div class="loc-box">
                    ...
                    <?php if($t['lat_pemberi'] && $t['lng_pemberi']): ?>
                      <a href="https://maps.google.com/?q=<?= $t['lat_pemberi']; ?>,<?= $t['lng_pemberi']; ?>"
                         target="_blank" class="d-block mt-1" style="btn btn-primary w-100 mt-2;">
                ...
                <div class="col-6">
                  <div class="loc-box">
                    ...
                    ?>
                        <a href="<?= $url_navigasi; ?>" target="_blank" class="btn btn-primary w-100 mt-2">
